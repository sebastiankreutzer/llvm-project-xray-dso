...
extern int32_t __xray_register_dso(const XRaySledEntry* SledsBegin, const XRaySledEntry* SledsEnd, const XRayFunctionSledIndex* FnIndexBegin, const XRayFunctionSledIndex* FnIndexEnd, XRayTrampolines Trampolines);
...
bool patchFunctionEntry(bool Enable, uint32_t FuncId, const XRaySledEntry &Sled,
                        void (*Trampoline)());
bool patchFunctionExit(bool Enable, uint32_t FuncId, const XRaySledEntry &Sled, void (*Trampoline)());
bool patchFunctionTailExit(bool Enable, uint32_t FuncId,
                           const XRaySledEntry &Sled, void (*Trampoline)());
bool patchCustomEvent(bool Enable, uint32_t FuncId, const XRaySledEntry &Sled, void (*Trampoline)());
bool patchTypedEvent(bool Enable, uint32_t FuncId, const XRaySledEntry &Sled, void (*Trampoline)());
